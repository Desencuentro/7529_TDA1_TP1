...
\begin{itemize}
    ...
    \item Calculamos $P_X=X_0+X_1$ e $P_Y=Y_0+Y_1$.
    \item Obtendremos recursivamente (para n>1) las 3 multuplicaciones: $M_0 = X_0\times Y_0$, $M_1 = X_1\times Y_1$, y $P = P_X\times P_Y$.
